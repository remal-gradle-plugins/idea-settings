...
[![configuration cache: not supported](https://img.shields.io/static/v1?label=configuration%20cache&message=not%20supported&color=inactive)](https://docs.gradle.org/current/userguide/configuration_cache.html) [![isolated projects: not supported](https://img.shields.io/static/v1?label=isolated%20projects&message=not%20supported&color=inactive)](https://docs.gradle.org/current/userguide/isolated_projects.html)
...
```groovy
plugins {
    id 'name.remal.idea-settings' version '4.0.9'
}
```
<!--/plugin-usage-->
